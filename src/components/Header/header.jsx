...
import './header.css';
import slt from '../images/Heimdal_Security_Software_logo_logotype-removebg-preview.png'
...
export default function Example() {
  ...
  return (
    <header className="bg-white" id='not'>
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5" id='bg'>
            <span className="sr-only">Advast</span>
            <img className="vht" src={slt} alt="" width={160} />
          </a>
        </div>
